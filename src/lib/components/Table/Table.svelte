...
<style>
	...
	.lumi-table {
		...
		--table-shell-bg: color-mix(
			in srgb,
			var(--lumi-color-surface) 70%,
			var(--lumi-color-background-hover) 30%
		);
		--table-shell-border: color-mix(
			in srgb,
	...
	.lumi-table__wrapper {
		...
		background:
			...
			var(--table-shell-bg);
		border: var(--lumi-border-width-thin) solid var(--table-shell-border);
